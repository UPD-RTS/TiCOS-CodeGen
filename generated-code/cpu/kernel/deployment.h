...
#define POK_CONFIG_PARTITIONS_NTHREADS	{7, 9}

#define POK_NEEDS_SCHED_O1	1

#define POK_CONFIG_PRIORITY_LEVELS	19
...
#define POK_CONFIG_NB_PORTS	4

#define POK_CONFIG_NB_GLOBAL_PORTS	4

#define POK_CONFIG_MAX_QUEUING_MESSAGES 	2

#define POK_CONFIG_PARTITIONS_PORTS	{0,0,1,1}
...
#define POK_CONFIG_PARTITIONS_NLOCKOBJECTS	{1, 2}
